...
const changeSiteBackground = (color: string): void => {
    (<HTMLElement>document.querySelector('.center-box > p')).innerText = `Background Color : ${color}`;
    (<HTMLElement>document.querySelector('.main-content')).style.backgroundColor = color;
}
